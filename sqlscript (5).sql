REM   Script: update queries 004
REM   update queries 004
...
update client_master004 set city='Bangalore' where clientno='C00005';

update client_master04 set Bal_Due=1000 where clientno='C00001';

update client_master004 set Bal_Due=1000 where clientno='C00001';

update product_master004 set Cost_Price=750 where description='Trousers';
